...
public class DBService {
	...
	public void intenciaDb() {
		Tecnico tec1 = new Tecnico(null, "Itaitan", "238.184.420-10", "itaitan@gmail.com", encoder.encode("123"));
		...
		Cliente cli1 = new Cliente(null, "Sabino", "836.527.220-27", "sabino@gmail.com", encoder.encode("123"));
